...
import com.helyx.helyxhr.notifications.system.EmailDispatcher;
...
import com.helyx.helyxhr.notifications.system.EmailStatus;
...
class EmailSmtpDeliveryTest extends TenantIsolationTestBase {
    ...
    void enqueuedEmail_isDeliveredToTheSmtpServerWithItsSubjectAndBody() throws Exception {
        ...
        String subject = "Welcome to Helyx";
        ...
        assertThat(delivered.getFrom()[0].toString()).isEqualTo("no-reply@helyx.test");
