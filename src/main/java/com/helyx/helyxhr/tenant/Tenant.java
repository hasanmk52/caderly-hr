...
/**
 * The cross-tenant root (PRD §21). Deliberately does NOT extend {@code common.BaseEntity}: it has
 * no tenant_id and no updated_at, and a dependency on {@code common} would close a package cycle
 * (common → tenant for the assignment listener). See ADR 0003.
 */
@Entity
@Table(name = "tenant")
public class Tenant {
