package com.caderly.caderlyhr.bootstrap;
...
class DevDataSeeder implements ApplicationRunner {
    ...
    DevDataSeeder(
            ...
            @Value("${caderly.dev.tenant-slug:mhzgroup}") String tenantSlug,
            @Value("${caderly.dev.tenant-name:MHZ Group}") String tenantName,
            @Value("${caderly.dev.admin-email:admin@mhzgroup.test}") String adminEmail,
            @Value("${caderly.dev.admin-password:DevAdmin12345}") String adminPassword) {
